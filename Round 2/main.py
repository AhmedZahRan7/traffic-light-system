...
NUM_EPISODES = 50 # Number of complete simulation runs
...
if __name__ == "__main__":
    ...
    for e in range(NUM_EPISODES):
        ...
        vehicles = gen_sim('', round=COMPETITION_ROUND,
                        ...
                        p_north_south=random.uniform(0.,.9), p_south_north=random.uniform(0.1,.9))
    ...
    f.write("avg is {} ,emission is {}\n".format(avg/NUM_EPISODES,emission/NUM_EPISODES))